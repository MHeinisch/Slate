...
namespace Slate_Reborn.Controllers
{
    public class EmployeeInfoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmpId,Name,PhoneNumber,Address,Email,Password,ConfirmPassword,UserId")] EmployeeInfo employeeInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmpId,Name,PhoneNumber,Address,Email,Password,ConfirmPassword,UserId")] EmployeeInfo employeeInfo)
        {
            if (ModelState.IsValid)
            {
